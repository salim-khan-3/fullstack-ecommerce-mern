...
const products = [
  {
    ...
    img: pp,
    rating: 5,
    description: "Classic smooth and creamy caramel candies made with real butter and fresh cream for a rich, melting taste.",
  },
  {
    id: 2,
    ...
    rating: 4,
    recommended: true,
    description: "Flavorful, pre-cooked meatballs seasoned with Italian herbs and spices. Perfect for pasta, subs, or as a quick snack.",
  },
  {
    id: 3,
    ...
    img: pp,
    rating: 5,
    description: "The perfect balance of sugar and sea salt. Non-GMO, gluten-free, and only 70 calories per cup for guilt-free snacking.",
  },
  {
    id: 4,
    ...
    rating: 5,
    organic: true,
    description: "A coconut-based vegan cheese alternative that melts beautifully. Creamy and rich with a sophisticated savory finish.",
  },
  {
    id: 5,
    ...
    img: pp,
    rating: 5,
    description: "Farm-fresh, organic grapes bursting with natural sweetness. A healthy, juicy addition to your daily fruit bowl.",
  },
];
